...
export default function SchemeCard({ scheme }: SchemeCardProps) {
  ...
  return (
    <article
      className="relative flex h-[300px] sm:h-[340px] w-[240px] sm:w-[280px] flex-col overflow-hidden rounded-2xl bg-white transition-all duration-300 hover:-translate-y-1 hover:shadow-lg"
      style={{
    ...
    >
      ...
      <div
        className="relative flex h-[120px] sm:h-[160px] w-full items-center justify-center"
      ...
      <div className="flex flex-col p-3.5 sm:p-4 flex-1">
        <h3 className="text-[13px] sm:text-[14.5px] font-semibold leading-snug text-[#131313] line-clamp-2">
          {scheme.title}
        </h3>
