      ...
      {isOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className={`relative w-full md:max-w-none bg-[#131210] border border-[#2A2925] rounded-3xl shadow-[0_24px_50px_-12px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col md:flex-row h-auto max-h-[90vh] transition-all duration-300 ${view === "calendar"
                ? "md:w-[1040px] md:h-[490px]"
                : "md:w-[760px] md:h-[450px]"
              }`}
          >
            ...
            {view === "success" ? (
              ...
              <>
                ...
                <div className="flex-1 flex flex-col overflow-y-auto min-h-0 bg-[#131210]">
                  ...
                  {/* View 2: Booking Form */}
                  {view === "form" ? (
                    <form onSubmit={handleSubmit} className="p-6 md:p-8 flex flex-col gap-5 text-left text-neutral-200">
                    ...
                    <div className="flex flex-col md:flex-row h-full min-h-0">
                      ...
                      <div className={`flex justify-center flex-1 ${mobileShowTimes ? "hidden md:flex" : "flex"}`}>
                        <ScheduleCalender
